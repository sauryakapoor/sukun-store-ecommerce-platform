...
.btn-primary:is(:hover, :focus) { background-color: #007bff; }
...
.footer .logo {
  display: none; /* Keep this as is if you want to hide the logo */
}

.footer {
  background-color: var(--cultured-1);
  padding-block: 70px;
  transition: all 0.5s ease; /* Smooth transition for background color changes */
}
...
@media (max-width: 1500px) {
  .footer-list-title {
    font-size: var(--fs-4); /* Adjust font size for smaller screens */
  }

  .footer-list-text, .footer-link {
    font-size: var(--fs-6); /* Adjust font size for smaller screens */
  }

  .newsletter-title {
    font-size: var(--fs-2); /* Adjust font size for smaller screens */
  }
}
...
/* More Links Dropdown (Ellipsis) */
.nav-item.dropdown#moreLinksDropdown {
  position: relative;
}

.nav-item#moreLinksDropdown .dropdown-menu {
  display: none;
  position: absolute;
  top: 100%;
  left: 0;
...
.nav-item#moreLinksDropdown .dropdown-menu a {
  display: flex;
  align-items: center;
  padding: 12px;
  color: #333;
...
.nav-item#moreLinksDropdown .dropdown-menu a:hover {
  background-color: #f0f0f0;
  color: #007bff;
}

.nav-item#moreLinksDropdown .dropdown-menu i {
  margin-right: 8px;
}

/* Show the More Links dropdown on hover */
.nav-item#moreLinksDropdown:hover .dropdown-menu {
  display: block;
}

/* Style the ellipsis icon */
.nav-item#moreLinksDropdown i {
  font-size: 20px;
  color: #333;
}
...
.manu .btn-link:is(:hover, :focus) { color: var(--hoockers-green); }

.manu-card .card-banner {
  position: relative;
  overflow: hidden;
}
...
.manu-card .action-btn:is(:hover, :focus) {
  background-color: var(--black);
  color: var(--white);
}

.manu-card:is(:hover, :focus-within) .card-actions {
  opacity: 1;
  transform: translate(-20px, -50%);
}

.manu-card .card-content {
  padding-block: 20px;
  text-align: center;
}

.manu-card :is(.price, .card-rating, .rating-wrapper) {
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 5px;
...
.manu-card .price .span {
  color: var(--black);
  font-weight: var(--fw-700);
}

.manu-card .card-title {
  color: var(--black);
  font-size: var(--fs-7);
  font-weight: var(--fw-500);
  margin-block-end: 8px;
...
.manu-card .card-title:is(:hover, :focus) {
  text-decoration: underline;
  color: var(--hoockers-green);
}

.manu-card .rating-wrapper {
  gap: 2px;
  color: var(--hoockers-green);
  font-size: 15px;
}

.manu-card .rating-text {
  font-size: var(--fs-8);
  font-weight: var(--fw-400);
  line-height: 1;
}
...
.electronics .btn-link:is(:hover, :focus) { color: var(--hoockers-green); }

.electronics-card .card-banner {
  position: relative;
  overflow: hidden;
}
...
.electronics-card .action-btn:is(:hover, :focus) {
  background-color: var(--black);
  color: var(--white);
}

.electronics-card:is(:hover, :focus-within) .card-actions {
  opacity: 1;
  transform: translate(-20px, -50%);
}
...
.electronics-card :is(.price, .card-rating, .rating-wrapper) {
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 5px;
...
.electronics-card .del {
  font-size: var(--fs-9);
  font-weight: var(--fw-400);
}

.electronics-card .price .span {
  color: var(--black);
  font-weight: var(--fw-700);
}

.electronics-card .card-title {
  color: var(--black);
  font-size: var(--fs-7);
  font-weight: var(--fw-500);
  margin-block-end: 8px;
...
.electronics-card .card-title:is(:hover, :focus) {
  text-decoration: underline;
  color: var(--hoockers-green);
}

.electronics-card .rating-wrapper {
  gap: 2px;
  color: var(--hoockers-green);
  font-size: 15px;
}

.electronics-card .rating-text {
  font-size: var(--fs-8);
  font-weight: var(--fw-400);
  line-height: 1;
}
...
.alert.active {
  display: block; /* Show the main content after the loader */
}
/* Dark mode styles */
body.dark-mode {
  background-color: var(--black);
...
#saurya .sk-box:hover {
  box-shadow: 10px 10px 54px rgba(22, 22, 23, 0.1);
}
#saurya .sk-box img {
  width: 100%;
  margin-bottom: 5px;
