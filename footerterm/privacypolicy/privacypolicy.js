...
<pre>
    ...
    Privacy Policy describes how SukunStore Internet Private Limited and its affiliates (collectively “SukunStore, we, our,
    us”) collect, use, share or otherwise process your personal data through SukunStore website www.SukunStore.com, its
    ...
    If you enroll into our loyalty and membership program, such SuperCoin, VIP or similar programs offered by SukunStore,
    ...
    SukunStore or a third-party business partner that operates online/offline establishments or platforms where you can
    earn loyalty points for purchase of goods and services, and redeem loyalty points. We will also collect your
    information related to your transactions on SukunStore platform and such third-party business partner platforms. When
    such a third-party business partner collects your personal data directly from you, you will be governed by their
    privacy policies. Additionally, we collect your UPI ID if you choose to pay via our SukunStore UPI platform. SukunStore
    ...
    SukunStore has onboarded certain third-party business partners on the Platform who specialize in the categories like
    ...
    Ultra-Partners websites/applications will be based on your SukunStore login credentials after seeking your permissions
    to share the data further. SukunStore shall not be responsible for the Ultra-Partner’s privacy practices or the
    ...
    We may share personal data internally within SukunStore group companies including SukunStore Advanz Private Limited,
    Scapic Innovations Private Limited, and other SukunStore affiliates, related companies and third parties, including
    ...
    insurance, the deferred payment options, SukunStore PayLater offered by SukunStore Advanz Private Limited through its
    ...
    will be governed by their privacy policies. SukunStore shall not be responsible for the privacy practices or the
    content of their privacy policies, and we request you to read their privacy policies prior to disclosing any
    information.
    ...
    [https://www.SukunStore.com/communication-preferences/email] to unsubscribe/opt-out.
    ...
    using your device’s settings application. SukunStore will have no access to your GAID once you select this feature.
    ...
    you if we believe it may be necessary to prevent fraud or future abuse, to enable SukunStore to exercise its legal
